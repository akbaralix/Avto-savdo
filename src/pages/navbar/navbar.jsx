...
import { FaRegBell, FaRegHeart, FaHeart, FaPlus, FaBars, FaTimes, FaRegUser, FaUser, FaHome, FaCar } from "react-icons/fa";
    ...
    <>
      ...
      <div className="bottom-navbar">
        <NavLink to="/" className={({ isActive }) => `bottom-nav-item ${isActive ? "active" : ""}`}>
          ...
          <span className="bottom-nav-label">Bosh sahifa</span>
        </NavLink>
        
        <NavLink to="/elonlar" className={({ isActive }) => `bottom-nav-item ${isActive ? "active" : ""}`}>
          <FaCar className="bottom-nav-icon" />
          <span className="bottom-nav-label">E'lonlar</span>
        </NavLink>
        
        <NavLink to="/sevimli" className={({ isActive }) => `bottom-nav-item ${isActive ? "active" : ""}`}>
          <div className="bottom-nav-icon-wrapper">
            {favorites.length > 0 ? (
              <FaHeart className="bottom-nav-icon active-heart" />
            ) : (
          ...
          <span className="bottom-nav-label">Sevimlilar</span>
        </NavLink>
        ...
        <NavLink to="/profile" className={({ isActive }) => `bottom-nav-item ${isActive ? "active" : ""}`}>
          <div className="bottom-nav-icon-wrapper">
            {user ? (
              user.photo_url ? (
                <img src={user.photo_url} alt="Profile" className="bottom-nav-avatar-img" />
              ) : (
                <FaUser className="bottom-nav-icon" />
              )
            ) : (
              <FaRegUser className="bottom-nav-icon" />
            )}
          </div>
