...
function Elonlar() {
  ...
  // Sync state if URL params change (e.g. user navigates from home page category cards)
  useEffect(() => {
  ...
  return (
    <div className="elonlar-container">
      <div className="elonlar-header">
        ...
        <p>Jami topildi: <strong>{filteredCars.length} ta</strong> avtomobil</p>
      </div>
        ...
        <main className="listings-main">
          {filteredCars.length > 0 ? (
            ...
            <div className="no-cars-found">
              ...
              <p>Iltimos, filtrlash parametrlarini o'zgartirib qayta urinib ko'ring.</p>
